...
<body>
            ...
            <tbody>
                <c:forEach var="order" items="${orderList}">
                    <tr>
                        ...
                        <td>${order.discountAmount}원</td>
                        <td>${order.finalAmount}원</td>
    ...
    <script>
        ...
        function addToCart(menuId, menuName, unitPrice) {
            ...
            if (exist) { exist.qty++; }
            else { cart.push({ menuId, menuName, unitPrice, qty: 1 }); }
            renderCart();
        }
        ...
        function updateTotal() {
            var total    = cart.reduce((s, c) => s + c.unitPrice * c.qty, 0);
        ...
        function openStatusPopup(orderId, currentStatus) {
            ...
            document.querySelectorAll('.btn-status-opt').forEach(function(b) {
                b.classList.toggle('active', b.getAttribute('data-value') === currentStatus);
            });

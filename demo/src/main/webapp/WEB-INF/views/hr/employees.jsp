	...
	<div class="content">
		...
		<div class="top-bar">
			...
			<button onclick="location.href='/hr/employees?status=resigned'">
				퇴사자</button>
			<button onclick="location.href='/hr/employees/register'">직원
				등록</button>
		...
		<form action="/hr/employees" method="get" style="margin: 10px 0;">
			이름: <input type="text" name="name" value="${param.name}"> 직책:
			<input type="text" name="position" value="${param.position}">
						...
						<tr>
							...
							<td>
								...
								<button class="edit-btn"
									...
									수정</button> <!-- 삭제 버튼  -->
								<form action="/hr/employees/delete" method="post"
